...
def scrape_info():
    ...
    facts_df.to_html('./templates/facts.html')
    ...
    mars_data = {
        "ArticleTitle" : news_title,
        "ArticleBody" : news_bod,
        "FeaturedImage" : featured_image_url,
        "MarsWeather" : mars_weather,
        "Cerberus" : cerberus_title,
        "CerberusImage" : cerberus_img,
        "Schiaparelli" : schia_title,
        "SchiaparelliImage": schia_img,
        "Syrtis" : syrtis_title,
        "SyrtisImage" : syrtis_img,
        "Valles" : valles_title,
        "VallesImage" : valles_img
    }
